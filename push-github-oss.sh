...
ALLOWED_PATHS='^(pkg/core/|pkg/adapter/|pkg/plugin/interface.go$|pkg/plugin/oss/|pkg/admin/|pkg/config/|cmd/|webui/|config.yaml$|go.mod$|go.sum$|LICENSE$|NOTICE$|README.md$|README.en-US.md$)'
