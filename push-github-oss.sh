...
ALLOWED_PATHS='^(pkg/core/|pkg/mcp/|pkg/adapter/|pkg/plugin/interface.go$|pkg/plugin/permissions.go$|pkg/plugin/privacy_seed.go$|pkg/plugin/privacy_seed_test.go$|pkg/plugin/oss/|pkg/license/|pkg/admin/|pkg/config/|cmd/gateway/|webui/|config.yaml$|go.mod$|go.sum$|LICENSE$|NOTICE$|README.md$|README.en-US.md$)'
